...
public class SpongeBstatsLite {
    ...
    static {
        ...
        if (System.getProperty("bstats.relocatecheck") == null || !System.getProperty("bstats.relocatecheck").equals("false")) {
            ...
            if (SpongeBstatsLite.class.getPackage().getName().equals(defaultPackage) || SpongeBstatsLite.class.getPackage().getName().equals(examplePackage)) {
    ...
    @Inject
    public SpongeBstatsLite(PluginContainer plugin, Logger logger, @ConfigDir(sharedRoot = true) Path configDir) {
        if (created) {
