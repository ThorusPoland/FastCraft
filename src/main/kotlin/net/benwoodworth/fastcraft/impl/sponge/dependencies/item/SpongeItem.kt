package net.benwoodworth.fastcraft.impl.sponge.dependencies.item
...
class SpongeItem(
    ...
    override val name: Text
        get() = net.benwoodworth.fastcraft.impl.sponge.dependencies.text.SpongeText(Sponge_Text.of(base))

    override var displayName: Text?
        get() {
            val displayName = base.get(Keys.DISPLAY_NAME).orElse(null)
            return net.benwoodworth.fastcraft.impl.sponge.dependencies.text.SpongeText(displayName)
        }
        set(value) {
            value as net.benwoodworth.fastcraft.impl.sponge.dependencies.text.SpongeText
    ...
    override var lore: List<Text?>?
        get() {
            ...
            return lore?.map {
                it?.run { net.benwoodworth.fastcraft.impl.sponge.dependencies.text.SpongeText(it) }
            }
        }
        set(value) {
            base.offer(Keys.ITEM_LORE, value?.map {
                it?.run { (this as net.benwoodworth.fastcraft.impl.sponge.dependencies.text.SpongeText).base }
            })
        }
