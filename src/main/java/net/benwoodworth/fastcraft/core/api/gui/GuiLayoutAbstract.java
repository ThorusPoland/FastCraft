 ...
 */
public abstract class GuiLayoutAbstract<TItem> {
     ...
     */
    public final void addLayout(@NotNull GuiLayoutAbstract<TItem> layout, int x, int y) {
    ...
    public class LayoutCoordinate {
        @NotNull
        final GuiLayoutAbstract<TItem> layout;
        final int x, y;

        LayoutCoordinate(@NotNull GuiLayoutAbstract<TItem> layout, int x, int y) {
            this.layout = layout;
            this.x = x;
            this.y = y;
        }
